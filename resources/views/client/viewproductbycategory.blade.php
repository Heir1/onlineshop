                 ...
                 <div class="product product-cat">
                    <div class="row">
                       ...
                       <div class="col-md-4 item item-product-cat">
                          <div class="inner">
                             <div class="thumb">
                                <div class="photo" style="background-image:url(assets/uploads/product-featured-83.jpg);"></div>
                                <div class="overlay"></div>
                             </div>
                             <div class="text">
                       ...
                       <div class="col-md-4 item item-product-cat">
                          <div class="inner">
                             <div class="thumb">
                                <div class="photo" style="background-image:url(assets/uploads/product-featured-88.jpg);"></div>
                                <div class="overlay"></div>
                             </div>
                             <div class="text">
