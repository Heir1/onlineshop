                        ...
                        <table id="example1" class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        <td>{{$increment++}}</td>
                                        <td style="width:82px; "><img src="{{asset('/storage/productimages/'.$product->p_featured_photo)}}" alt="Women's Plus-Size Shirt Dress with Gold Hardware" style="width:80px; border-radius: 50%"></td>
                                ...
                                {{-- <tr>
                                <td>2</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-101.jpg')}}" alt="Digital Infrared Thermometer for Adults and Kids" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>3</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-100.jpg')}}" alt="Men's Long Cuffed Jogger Yoga Sweat Pant" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>4</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-99.jpg')}}" alt="Oculus Quest 2 - Advanced All-In-One Virtual Reality Headset" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>5</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-98.jpg')}}" alt="Women's Fuzzy Fleece Lapel Open Front Long Cardigan Coat" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>6</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-97.jpg')}}" alt="Women's Tea Length Dress with Rosette Detail (Petite & Regular)" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>7</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-96.jpg')}}" alt="Men's Loose Fit Heavyweight Long-Sleeve Pocket T-Shirt" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>8</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-95.jpg')}}" alt="Bose QuietComfort 45 Bluetooth Wireless Headphones" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>9</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-94.jpg')}}" alt="WD 5TB Elements Portable External Hard Drive HDD" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>10</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-93.jpg')}}" alt="Gold Plated Leopard Print Crystal Big Round Hoop Earrings" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>11</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-92.jpg')}}" alt="Travelpro Laptop Carry-on Travel Tote Bag" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>12</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-91.jpg')}}" alt="Women's Oversized Fleece Hoodie" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>13</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-90.jpg')}}" alt="Women's Thin Cotton Zip Up Hoodie Jacket" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>14</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-89.jpg')}}" alt="Men's Fleece Jogger Pant" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>15</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-88.jpg')}}" alt="Under Armour Men's Sportstyle Left Chest Short Sleeve T-shirt" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>16</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-87.jpg')}}" alt="Truck Boys Pajamas Toddler Sleepwear Clothes" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>17</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-86.jpg')}}" alt="Amazfit GTS 3 Smart Watch for Android iPhone" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>18</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-85.jpg')}}" alt="Men's Soft Classic Sneaker" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>19</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-84.jpg')}}" alt="Loose-fit One-Shoulder Cutout Rib Knit Maxi Dress" style="width:80px;"></td>
                                ...
                                <tr>
                                <td>20</td>
                                <td style="width:82px;"><img src="{{asset('backend/admin/uploads/product-featured-83.jpg')}}" alt="Men's Ultra Cotton T-Shirt, Multipack" style="width:80px;"></td>
