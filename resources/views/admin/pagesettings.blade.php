                                ...
                                <div class="box-body">
                                   ...
                                   <div class="form-group">
                                      ...
                                      <div class="col-sm-6" style="padding-top:6px;">
                                         <img src="{{asset('backend/admin/uploads/about-banner.jpg')}}" class="existing-photo" style="height:80px;">
                                      </div>
                                   </div>
                                   <div class="form-group">
                             ...
                             <div class="box box-info">
                                <div class="box-body">
                                   ...
                                   <div class="form-group">
                                      <label for="" class="col-sm-3 control-label">Existing Banner Photo</label>
                                      <div class="col-sm-6" style="padding-top:6px;">
                                         <img src="{{asset('backend/admin/uploads/faq-banner.jpg')}}" class="existing-photo" style="height:80px;">
                                      </div>
                                   </div>
                                   <div class="form-group">
                                      <label for="" class="col-sm-3 control-label">New Banner Photo</label>
                             ...
                             <div class="box box-info">
                                <div class="box-body">
                                   ...
                                   <div class="form-group">
                                      <label for="" class="col-sm-3 control-label">Existing Banner Photo</label>
                                      <div class="col-sm-6" style="padding-top:6px;">
                                         <img src="{{asset('backend/admin/uploads/contact-banner.jpg')}}" class="existing-photo" style="height:80px;">
                                      </div>
                                   </div>
                                   <div class="form-group">
                                      <label for="" class="col-sm-3 control-label">New Banner Photo</label>
