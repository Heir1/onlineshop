                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                <tr>
                                <td>1</td>
                                <td style="width:150px;"><img src="{{asset('backend/admin/uploads/slider-1.png')}}" alt="Welcome to Ecommerce PHP" style="width:140px;"></td>
                                ...
                                <tr>
                                <td>2</td>
                                <td style="width:150px;"><img src="{{asset('backend/admin/uploads/slider-2.jpg')}}" alt="50% Discount on All Products" style="width:140px;"></td>
                                ...
                                <tr>
                                <td>3</td>
                                <td style="width:150px;"><img src="{{asset('backend/admin/uploads/slider-3.png')}}" alt="24 Hours Customer Support" style="width:140px;"></td>
