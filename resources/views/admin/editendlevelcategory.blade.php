                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <select name="tcat_id" class="form-control select2 top-cat">
                                        <option value="{{$endlevelcategory->tcat_id}}" required>{{$endlevelcategory->tcat_id}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="mcat_id" class="form-control select2 mid-cat">
                                        <option value="{{$endlevelcategory->mcat_id}}" required>{{$endlevelcategory->mcat_id}}</option>
