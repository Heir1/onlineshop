                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6" style="padding-top:6px;">
                                                @if ($logo)
                                                    <img src="{{asset('storage/logoimage/'.$logo->logo)}}" class="existing-photo" style="height:80px;">                                          
                                                @else
                            ...
                            <form class="form-horizontal" action="{{ $message ? url('admin/updatemessage', [$message->id]) : url('admin/savemessage') }}" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="receive_email_thank_you_message">{{$message ? $message->receive_email_thank_you_message : ''}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Forget password Message</label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="forget_password_message">{{$message ? $message->forget_password_message : ''}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-5">
                                            <button type="submit" class="btn btn-success pull-left" name="form4">{{$message ? 'Update' : 'Save'}}</button>
                                        </div>
                                    </div>
                                </div>
                                </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        ...
                                        <p>>   
                                            <img src="{{asset('backend/admin/uploads/banner_reset_password.jpg')}}" alt="" style="width: 100%;height:auto;">   
                                        </p>
                                    </td>
                                    <td style="width:50%">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        ...
                                        <p>
                                            <img src="{{asset('backend/admin/uploads/banner_search.jpg')}}" alt="" style="width: 100%;height:auto;">  
                                        </p>
                                    </td>
                                    <td style="width:50%">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        ...
                                        <p>
                                            <img src="{{asset('backend/admin/uploads/banner_cart.jpg')}}" alt="" style="width: 100%;height:auto;">  
                                        </p>
                                    </td>
                                    <td style="width:50%">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        ...
                                        <p>
                                            <img src="{{asset('backend/admin/uploads/banner_checkout.jpg')}}" alt="" style="width: 100%;height:auto;">  
                                        </p>
                                    </td>
                                    <td style="width:50%">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        ...
                                        <p>
                                            <img src="{{asset('backend/admin/uploads/banner_product_category.jpg')}}" alt="" style="width: 100%;height:auto;">  
                                        </p>
                                    </td>
                                    <td style="width:50%">
