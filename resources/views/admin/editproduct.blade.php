                    ...
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{asset('backend/admin/uploads/product-featured-102.jpg')}}" alt="" style="width:150px;">
                            ...
                            <div class="form-group">
                                ...
                                <table id="ProductTable" style="width:100%;">
                                    <tbody>
                                        <tr>
                                            <td>
                                            <img src="{{asset('backend/admin/uploads/product_photos/132.jpg')}}" alt="" style="width:150px;margin-bottom:5px;">
                                            </td>
                                            <td style="width:28px;">
