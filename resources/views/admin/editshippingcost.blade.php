...
@section('content')
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
               <div class="row">
                  <div class="col-md-12">
                     <form class="form-horizontal" action="{{ url('admin/updateshippingcost', [$shippingcost->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="box box-info">
                           <div class="box-body">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <select name="country_id" class="form-control select2">
                                       <option value="{{$shippingcost->country_id}}">{{$shippingcost->country_id}}</option>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input type="number" class="form-control" name="amount" value="{{$shippingcost->amount}}" required>
                                 </div>
                              </div>
                              <div class="form-group">
